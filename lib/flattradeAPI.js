...
export async function ftPlaceOrder(data, jkey) {
...
export async function ftCancelOrder(uid, jkey, prd, tsym, trantype) {
  const [norenordno, qty] = await ftGetOrderNo(uid, jkey, prd, tsym, trantype);
...
export async function ftModifyOrder(data, jkey) {
...
export async function ftGetOrderNo(uid, jkey, prd, tsym, trantype) {
...
export async function ftGetOpenPosition(userId, tsym, jkey) {
...
export async function ftClosePosition(userId, tsym, prc, jkey) {
  const pos = await ftGetOpenPosition(userId, tsym, jkey);
